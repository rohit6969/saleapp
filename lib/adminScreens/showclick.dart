...
class BTSShowClick extends StatefulWidget {
  String title;
  BTSShowClick({this.title});
  @override
  _BTSShowClickState createState() => _BTSShowClickState();
}

class _BTSShowClickState extends State<BTSShowClick> {
  bool accIsLoggedIn;
            ...
            children: <Widget>[
              ...
              new StreamBuilder(
                  stream: Firestore.instance
                      ...
                      .where(sliderName, isEqualTo: widget.title)
                      .snapshots(),
