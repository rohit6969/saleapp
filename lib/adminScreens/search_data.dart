...
import 'package:Sale_App/userScreens/searchData.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class BTSSearchData extends StatefulWidget {
  @override
  _BTSSearchDataState createState() => _BTSSearchDataState();
}

var lists = [];

class _BTSSearchDataState extends State<BTSSearchData> {
  var queryResultSet = [];
  var tempSearchStore = [];
                ...
                return InkWell(
                    onTap: () {
                      Navigator.of(context).push(new CupertinoPageRoute(
                          builder: (context) => BTSSearchDisplay(
                              searchdata: element[productTitle])));
                    },
